...
static final short minBrightness = 50;
...
static final int displays[][] = new int[][] {
   {0,15,12} // Screen 0, 9 LEDs across, 6 LEDs down
...
static final int leds[][] = new int[][] {
  ...
  {0,14,8},
  {0,14,9},
  {0,14,10},  // Bottom edge, right half
  {0,14,11}, {0,13,11}, {0,12,11},{0,11,11},{0,10,11},{0,9,11}, {0,8,11}, {0,7,11}
